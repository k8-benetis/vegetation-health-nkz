       ...
       return (
          <div className="w-full h-full flex items-center justify-center bg-slate-50 rounded-lg border border-dashed border-slate-300">
             <div className="text-center">
                ...
                <p className="text-xs text-slate-400">Prueba con otro índice o fecha</p>
             </div>
          </div>
       );
  }
  ...
  return (
    <div className="w-full h-full p-4 bg-white rounded-lg">
      <div className="mb-2 flex justify-between items-end">
          <div>
            <h4 className="text-sm font-semibold text-slate-700">Serie Temporal: {indexType}</h4>
            <p className="text-xs text-slate-500">{data.length} puntos de datos (últimos 12 meses)</p>
          </div>
